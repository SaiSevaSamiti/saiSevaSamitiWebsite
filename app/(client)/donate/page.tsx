...
import { Heart, CreditCard, Building2, Smartphone, Trophy, ArrowRight, Info } from 'lucide-react'
...
export default function DonatePage() {
  ...
  const bankDetails = [
    { label: 'Account Name', value: 'Sai Seva Samiti' },
            ...
            <CardContent className="p-8 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Direct Account Transfer</p>
                </div>
              </div>
              ...
              <div className="pt-4 border-t">
                <div className="flex items-start gap-2 p-3 bg-warning/10 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Please use your name as reference and save the transaction receipt for verification.
                  </p>
                </div>
              </div>
            </CardContent>
      ...
      <Section shade="accent">
        <div className="max-w-3xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">Complete Your Donation</h2>
            <p className="text-muted-foreground">
              After making the payment, please fill out this form so we can verify and acknowledge your
              contribution.
            </p>
          </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="pt-4">
                  <div className="p-4 bg-muted rounded-lg mb-4">
                    <p className="text-sm text-muted-foreground">
                      <strong>Note:</strong> Your donation will be verified by our team within 24-48 hours.
                      You will receive a confirmation email once verified. Please keep your transaction
      ...
      {isLoading ? (
        ...
        <Section shade="secondary">
          <div className="text-center space-y-4 mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">Top Donors</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We're grateful to these generous supporters who have made significant contributions to our
              mission.
            </p>
          </div>
      ...
      <Section className="gradient-secondary text-secondary-foreground">
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <p className="text-lg opacity-90">
            Your donation directly supports our programs - from feeding the hungry to providing medical
            care and education. Together, we can create lasting change in our communities.
          </p>
